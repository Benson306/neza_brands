...
function TopFivePayouts() {
  ...
  useEffect(()=>{
    let adminConnectionString = `${process.env.REACT_APP_API_URL}/all_approved_payouts/${uid}`;
  ...
  return (
    <div className='mt-4'>
      <SectionTitle>Latest Approved Payouts</SectionTitle>
    <div className='w-full mx-auto'>
      ...
      <TableContainer className="mb-8">
        <Table>
          ...
          <TableBody>
            {
              !loading && !error && dataTable1.reverse().slice(0,6).map( (item, i) => (
              <TableRow key={i}>
                <TableCell>
